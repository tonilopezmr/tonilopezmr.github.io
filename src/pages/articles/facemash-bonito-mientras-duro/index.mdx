...
<Image src={faces} alt="Imágenes privadas descargadas de la UPV" />
...
<Image src={activeUsers} alt="8 de octubre a las 23:16:21" />
...
* * *
<Image src={totalEst} alt="Visión general hasta el momento." />
...
## Países y ciudades
* * *
<Image src={country} alt="Izquierda países, derecha Ciudades." />
...
## Sexo y edad
* * *
<Image src={ages} alt="Sexo y edad." />
...
## Dispositivo
* * *
<Image src={devices} alt="Dispositivos." />
...
* * *
<Image src={mobileSo} alt="Dispositivos Moviles." />
...
<a href="https://www.google.es/#q=facemash+upv"><Image src={googleFacemash} alt="Busqueda en google de Facemash UPV." /></a>

Al principio, solo ponía en **1º posición** el post que tiene mejor contenido sin aparecer directamente la url de [tonilopezmr.github.io/facemash](https://tonilopezmr.github.io/facemash), pero ahora si buscas ya te sale en 2º posición ya que google **premia mucho más las visitas y la duración que están en ella**.

Yo pensaba que nunca me lo pondría tan arriba, **lo importante es que [tonilopezmr.github.io](https://tonilopezmr.github.io) ya aparece 1º** y [Calcula Notas][5] ahora en [Google Play][10] está de las **primeras posiciones**.
