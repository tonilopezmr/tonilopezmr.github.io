...
At first, it only showed in **1st position** the post with better content without directly showing the [tonilopezmr.github.io/facemash](https://tonilopezmr.github.io/facemash) URL, but now if you search it appears in 2nd position since Google **rewards visits and duration much more**.

I thought it would never put me so high up, **the important thing is that [tonilopezmr.github.io](https://tonilopezmr.github.io) now appears 1st** and [Grade Calculator][5] is now in the **top positions** on [Google Play][10].
