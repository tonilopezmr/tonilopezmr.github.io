...
He obtenido tódas las imagenes de perfiles de la UPV desde su fundación y he creado [Facemash UPV](https://tonilopezmr.com/facemash).

## ¿Por qué?

Ya que estoy en **segundo curso de informática**, <del>[y quería promocionar la aplicación de Calcula Notas](https://tonilopezmr.com/calculanotas)</del> , me pareció divertido hacerle un pequeño homenaje al colega [Mark][1] que hizo lo mismo pero con imágenes robadas de perfiles privados, **yo no hice eso luego lo explicare**.
