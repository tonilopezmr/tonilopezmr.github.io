...
I obtained all the profile images from UPV since its foundation and created [Facemash UPV](https://tonilopezmr.github.io/facemash).

## Why?

Since I'm in my **second year of computer science**, <del>[and I wanted to promote the Grade Calculator app](https://tonilopezmr.github.io/calculanotas)</del>, I thought it would be fun to pay a small tribute to my friend [Mark][1] who did the same thing but with stolen images from private profiles, **I didn't do that, I'll explain later**.
